...
\begin{document}
  \begin{tikzpicture}[scale=0.6]
    ...
    \node[draw=none,align=center, font=\scriptsize,text width = 1.7cm, name=i3] at (-1.6,0) {};
    \draw [->] (i2) -- (i3);
    ...
    \node [draw=none,align=center, font=\scriptsize,text width = 1.7cm, name=g3] at (0,2.2) {x = 'inside1'};
    \draw [->] (g2) -- (g3);
  \end{tikzpicture}
\end{document}