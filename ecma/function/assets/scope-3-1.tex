...
\begin{document}
  \begin{tikzpicture}[scale=0.6]
    ...
    \node[draw=none,align=center, font=\scriptsize,text width = 1.7cm, name=o3] at (0,2.2) {x = 'outside'};
    \draw [->] (o2) -- (o3);
    ...
    \node [draw=none,align=center, font=\scriptsize,text width = 1.7cm, name=g3] at (0,3.6) {x = 'global'};
    \draw [->] (g2) -- (g3);
  \end{tikzpicture}
\end{document}